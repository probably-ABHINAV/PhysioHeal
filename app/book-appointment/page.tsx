` tags. I will focus on implementing the error handling and success feedback as described in the intention.
      ...
      if (data && data.length > 0) {
        const newAppointment = data[0];
          ...
          toast({
              ...
              description: `Your appointment ID is ${newAppointment.id}. We'll contact you shortly to confirm your appointment.`,
          })
      } else {
...
```
Applying improved error handling and displaying appointment ID in the success message.
```
